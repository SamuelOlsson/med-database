...
<body>
    <div id="login">
        <h3 class="text-center text-white pt-5">Register for the Claim Hospital Database!</h3>
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                    
                        <form action="register" method="post" name="register" id= "register" class="form-horizontal">
                           ...
                           <div class="form-group">
                            ...
                            <div id="register-link" class="text-right">
                                <a href="http://localhost:3500/MedicalDatabase/" class="text-info">Return to Home</a>
                            </div>
                        </form>
                    </div>
                </div>
